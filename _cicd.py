...
try:
    ...
    NPM = 'npm install'
    ChromeDriver = 'sudo wget https://dl.google.com/linux/direct/google-chrome-stable_current_amd64.deb && sudo apt install -y ./google-chrome-stable_current_amd64.deb && sudo apt-get clean -y && sudo apt-get update -y && sudo apt-get upgrade -f -y --fix-missing && google-chrome --version'
